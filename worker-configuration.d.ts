/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6da7eb96c72f4d3cbc998467fd34b63e)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	INLINE_RATE_LIMITER: RateLimit;
	UPDATE_RATE_LIMITER: RateLimit;
	BOT_INFO: {"id":1848460309,"is_bot":true,"first_name":"KinoriumBot","username":"kinorium_bot","can_join_groups":false,"can_read_all_group_messages":false,"supports_inline_queries":true,"supports_guest_queries":false,"can_connect_to_business":false,"has_main_web_app":false,"has_topics_enabled":false,"allows_users_to_create_topics":false,"can_manage_bots":false,"supports_join_request_queries":false};
	TOKEN: string;
	APIKEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_INFO" | "TOKEN" | "APIKEY" | "WEBHOOK_SECRET" | "ADMIN_ID">> {}
}
declare module "*.yaml" {
	const value: string;
