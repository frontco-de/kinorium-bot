/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: e0fb67da3995973c829820b17fa780cb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_INFO" | "APIKEY" | "TOKEN" | "WEBHOOK_SECRET">> {}
}
declare module "*.yaml" {
	const value: string;
