/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 392a04b8d24fbedf2c940615ebd6fd44)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	BOT_INFO: {"id":8872819363,"is_bot":true,"first_name":"KinoriumTest","username":"kinorium_test_bot","can_join_groups":true,"can_read_all_group_messages":false,"supports_inline_queries":true,"supports_guest_queries":true,"can_connect_to_business":false,"has_main_web_app":false,"has_topics_enabled":false,"allows_users_to_create_topics":false,"can_manage_bots":false,"supports_join_request_queries":false};
	TOKEN: string;
	APIKEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_INFO" | "TOKEN" | "APIKEY" | "WEBHOOK_SECRET">> {}
}
declare module "*.yaml" {
	const value: string;
