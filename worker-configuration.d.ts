/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 15fb9349e2180fb91e7d4f369c3e5e88)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	BOT_INFO: {"id":1848460309,"is_bot":true,"first_name":"KinoriumBot","username":"kinorium_bot","can_join_groups":false,"can_read_all_group_messages":false,"supports_inline_queries":true,"can_connect_to_business":false,"has_main_web_app":false};
	TOKEN: string;
	APIKEY: string;
